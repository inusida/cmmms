...
%>       
       <tr align="center" style="height: 30px">
         ...
         <td nowrap="nowrap"><a href="<%=basePath%>admin/system/add.jsp?method=updateAdmin&id=<%=pagelist2.get(0).toString()%>">编辑</a>
         <a href="<%=basePath%>AdminServlet?method=deleteAdmin&id=<%=pagelist2.get(0).toString()%>">删除</a></td>
       </tr>
<% }} %>
       <tr align="center" style="height: 30px">
