...
public class ComServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(method.equals("addlr")){  //老人信息
			...
			String str_sfz=cBean.getString("select id from lr where sfz='"+sfz+"'");
			String str_cw=cBean.getString("select id from lr where cw='"+cw+"'");
			if (str_sfz == null && str_cw == null){
