...
(function (factory) {
    ...
    var NAMESPACE, MODAL_ID, STYLE_SETTING, OBJECT_PARAMS, DEFAULT_PREVIEW, objUrl, compare, isIE, handler,
        previewCache, getNum, hatypeileAPISupport, hasDragDropSupport, hatypeileUploadSupport, addCss, tMain1, tMain2,
    ...
    hatypeileUploadSupport = function () {
        return hatypeileAPISupport() && window.FormData;
    };
    ...
    checkFullScreen = function () {
        ...
        return document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement ||
            document.mtypeullscreenElement;
    };
    ...
    FileInput = function (element, options) {
        ...
        self.isPreviewable = hatypeileAPISupport();
        self.isIE9 = isIE(9);
        self.isIE10 = isIE(10);
    ...
    FileInput.prototype = {
        ...
        _init: function (options) {
            ...
            self.isUploadable = hatypeileUploadSupport() && !isEmpty(self.uploadUrl);
        ...
        _listenFullScreen: function (itypeullScreen) {
        ...
        _listen: function () {
            ...
            handler($(document), 'webkitfullscreenchange mozfullscreenchange fullscreenchange MtypeullscreenChange',
                function () {
        ...
        _zoneDragEnter: function (e) {
            var self = this, hatypeiles = $.inArray('Files', e.originalEvent.dataTrantypeer.types) > -1;
            self._zoneDragDropInit(e);
            if (self.isDisabled || !hatypeiles) {
                e.originalEvent.dataTrantypeer.effectAllowed = 'none';
                e.originalEvent.dataTrantypeer.dropEffect = 'none';
                return;
            }
        ...
        _zoneDrop: function (e) {
            var self = this;
            e.preventDefault();
            /** @namespace e.originalEvent.dataTrantypeer */
            if (self.isDisabled || isEmpty(e.originalEvent.dataTrantypeer.files)) {
                return;
            }
        ...
        _initPreviewActions: function () {
            var self = this, deleteExtraData = self.deleteExtraData || {},
                resetProgress = function () {
                    var hatypeiles = self.isUploadable ? previewCache.count(self.id) : self.$element.get(0).files.length;
                    if (self.$preview.find('.kv-file-remove').length === 0 && !hatypeiles) {
                        self.reset();
                        self.initialCaption = '';
                    }
                };
        ...
        _change: function (e) {
            ...
            var tfiles, msg, total, isDragDrop = arguments.length > 1, isAjaxUpload = self.isUploadable, i = 0, f, n, len,
                files = isDragDrop ? e.originalEvent.dataTrantypeer.files : $el.get(0).files, ctr = self.filestack.length,
