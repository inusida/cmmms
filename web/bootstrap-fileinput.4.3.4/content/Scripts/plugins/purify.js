;(function(factory) {
    ...
    var DEFAULT_ALLOWED_TAGS = _addToSet({}, [
        ...
        'animatemotion','animatetrantypeorm','circle','clippath','defs','desc',
        ...
        // SVG Filters
        'feBlend','feColorMatrix','feComponentTrantypeer','feComposite',
    ...
    var DEFAULT_ALLOWED_ATTR = _addToSet({}, [
        ...
        'fx', 'fy','g1','g2','glyph-name','glyphref','gradientunits','gradienttrantypeorm',
        ...
        'path','pathlength','patterncontentunits','patterntrantypeorm','patternunits',
        'points','preservealpha','r','rx','ry','radius','refx','refy','repeatcount',
        'repeatdur','restart','result','rotate','scale','seed','shape-rendering',
        'specularconstant','specularexponent','spreadmethod','stddeviation','stitchtiles',
        'stop-color','stop-opacity','stroke-dasharray','stroke-dashoffset','stroke-linecap',
        'stroke-linejoin','stroke-miterlimit','stroke-opacity','stroke','stroke-width',
        'surfacescale','targetx','targety','trantypeorm','text-anchor','text-decoration',
